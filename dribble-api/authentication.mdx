...
| ----------------- | ----------------------------- | ---------------------------------- |
| `invalid_client`  | Incorrect Client ID or Secret | Double-check your app credentials  |
...
### Next steps
    ...
    <Card title="Quickstart" icon="square-code" href="/essentials/code">
    Try your first API request.
    </Card>

    <Card title="Check shots" icon="palette" href="/essentials/settings">
    Check the [Shots API] to fetch or display design shots.
    </Card>

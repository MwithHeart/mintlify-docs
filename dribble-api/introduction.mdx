...
A reverse-engineered documentation project where I analyzed and rewrote the **Authentication** and **Quickstart** sections of the [Dribble API](https://developer.dribble.com), focusing on improving clarity, developer onboarding, and content structure using Docusaurus.

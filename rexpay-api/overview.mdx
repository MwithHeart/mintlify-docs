...
With a single API, developers can accept **Card payments**, **Account Transfers**, and **USSD**, while gaining access to tools for settlement, reconciliation, and business growth.

The RexPay API is a RESTFUL one and by default, the API Docs demonstrates using curl to interact with the API over HTTP. 
...
<Columns cols={2}>
  ...
  <Card title="Get Payment Links" icon="link" href="/payment-links">
    Generate shareable links; no website or coding required.
  </Card>
  <Card title="Use SDKs & Plugins" icon="code" href="/sdks">
    Use client-side libraries and mobile SDKs for faster integrations.
  </Card>
  <Card title="Maximize the API Reference" icon="server" href="/api-reference">
...
<Columns cols={3}>
  ...
  <Card title="Simple & competitive Pricing" icon="code">
   
  </Card>
  <Card title="Easy Reconciliation and Settlement:" icon="image" >
  </Card>
</Columns>
...
<Card title="Check the API endpoints" icon="pen-to-square" href="./authentication">
  Learn how authentication works in details in the [Authentication Guide](./authentication).
</Card>
<Card title="Error Handling" icon="pen-to-square" href="./authentication">
  Learn how authentication works in details in the [Authentication Guide](./authentication).
</Card>
</CardGroup>